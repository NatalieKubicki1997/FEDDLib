...
template <class SC, class LO, class GO, class NO>
void AssembleFEStokesNonNewtonian<SC,LO,GO,NO>::set_LinearizationToNewton() {
...
template <class SC, class LO, class GO, class NO>
void AssembleFEStokesNonNewtonian<SC,LO,GO,NO>::assemblyStress(SmallMatrixPtr_Type &elementMatrix) {
...
template <class SC, class LO, class GO, class NO>
void AssembleFEStokesNonNewtonian<SC,LO,GO,NO>::assemblyStressDev(SmallMatrixPtr_Type &elementMatrix) {
...
template <class SC, class LO, class GO, class NO>
void AssembleFEStokesNonNewtonian<SC,LO,GO,NO>::assemblyNeumannBoundaryTerm(SmallMatrixPtr_Type &elementMatrix) //, dblVecPtr normalVector) 
{
...
template <class SC, class LO, class GO, class NO>
void AssembleFEStokesNonNewtonian<SC,LO,GO,NO>::assemblyNeumannBoundaryTermDev(SmallMatrixPtr_Type &elementMatrix) //, dblVecPtr normalVector) 
{
...
*/
template <class SC, class LO, class GO, class NO>
void AssembleFEStokesNonNewtonian<SC,LO,GO,NO>::buildTransformation(SmallMatrix<SC>& B){
...
template <class SC, class LO, class GO, class NO>
void AssembleFEStokesNonNewtonian<SC,LO,GO,NO>::applyBTinv( vec3D_dbl_ptr_Type& dPhiIn,
...
template <class SC, class LO, class GO, class NO>
void AssembleFEStokesNonNewtonian<SC,LO,GO,NO>::computeShearRate(  vec3D_dbl_Type dPhiTrans,
...
template <class SC, class LO, class GO, class NO>
void AssembleFEStokesNonNewtonian<SC,LO,GO,NO>::computeLocalViscosity()
{
	int dim = this->getDim();
	string FEType = this->FETypeVelocity_;
